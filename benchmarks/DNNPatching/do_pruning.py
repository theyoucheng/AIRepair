...
from Architecture.model import net, optimizer, scheduler
...
copyfile('./do_pruning.py', args.output_dir+'do_pruning.py')
copyfile('./Architecture/model.py', args.output_dir+'model.py')
