...
# python3 repair_confusion_exp_newbn_softmax.py --net_type resnet --dataset cifar10 --depth 18 --batch_size 128 --lr 0.1 --expname cifar10_resnet_2_4_dogcat_test --epochs 60 --beta 1.0 --cutmix_prob 0 --pretrained ./runs/cifar10_resnet18_2_4/model_best.pth.tar --lam 0 --extra 128 --eta 0.3 --checkmodel
...
def get_confusion(val_loader, model, criterion, epoch=-1):
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        other_classes = np.array([i for i in range(10) if i != args.pair1a and i != args.pair1b and i != args.pair2a and i != args.pair2b])
